    ...
    <div class="row">        
            <div class="col-7 mt-3 mb-2 afficherv" id="folder" style="height:100%;">
                ...
                <!-- Tab panes -->
                    <div class="container tab-content border mb-2" style=" background-color:rgba(255, 255, 255, 0.5); border-left:5px solid #081f3e; height:auto;">
                                            ...
                                            <form class="form-group" action="/action_page.php" style="width:100%;">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="col-4">
                                                        ...
                                                        <input type="text" class="form-control" style="border:none;" value="{{$patients->id}}"  disabled>
                                                    </div>
                                                </div>
                                                <div class="row mb-3">
                                                    <div class="form-group col">
                                                        <label for="poid" class="label-form ">Poids:</label>
                                                        <input type="text" class="form-control" value="" style="border:none;" disabled>
                                                    </div>
                                                    <div class="form-group col">
                                                        <label for="temp" class="label-form">Temperature:</label>
                                                        <input type="text" class="form-control" value="" disabled style="border:none;">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row mb-3 justify-content-around">    
                                                    <div class="form-group col">
                                                        ...
                                                        <input type="date" class="form-control" value="" disabled style="border:none;">
                                                    </div>
                                                    <div class="form-group col">
                                                ...
                                                <div class="row mb-3">
                                                    <div class="form-group col">
                                                        ...
                                                        <input type="text" class="form-control" id="ante" value="" disabled style="border:none;">
                                                    </div>
                                                    <div class="form-group col">
                                                        <label for="type" class="label-form">Type antecedant:</label><br>
                                                        <select name="type" id="" class="form-control" style="border:none;">
                                                            <option value=""></option>
                                                ...
                                                <div class="row mb-3">
                                                    <div class="form-group col">
                                                        ...
                                                        <select name="groupe" class="form-control" id="" style="border:none;">
                                                            <option value=""></option>
                                                    ...
                                                    <div class="form-group col">
                                                        ...
                                                        <input type="file" class="form-control" name="file" id="file" style="border:none;">
                                                    </div>
                                                </div>
                                                <div class="row">
                        ...
                        <div id="menu2" class="container tab-pane fade" style="height:100%;">
                                    <h3>Bilan Paraclinique</h3>
                                <div class="container d-flex justify-content-center" style="background-color:white;border-left:10px solid rgba(23, 111, 226, 0.87); border-radius:15px 15px; background-color:rgba(255, 255, 255, 0.5);">
                                    <form action="#" style="width:100%;background-color:white;">
                                        <div class="card " style="border:none;">
                                            <div class="card-body fadein  container" >
                                                <?php
                                                   if($patients->sexe_patient=="masculin"){
                                        ...
                                        <div class="row mb-3">
                                            <div class="form-group col">
                                                ...
                                                <input type="text" class="form-control" id="tension" value="" disabled style="border:none;">
                                            </div>
                                            <div class="form-group col">
                                                <label for="pwd" class="label-form">Date analyse:</label>
                                                <input type="date" class="form-control" id="pwd" value="" disabled style="border:none;">
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-group col-4">
                                                <label for="pwd" class="label-form">Heure resultat:</label>
                                                <input type="time" class="form-control" id="pwd" value="" disabled style="border:none;">
                                            </div>
                                        </div>
                                        <div class="row justify-content-around">   
                                            <div class="form-group col">
                                                <label for="tension" class="label-form">Designation:</label>
                                                <textarea name="designation" id="" class="form-control" cols="15" rows="8" style="border:none;" disabled></textarea>
                                            </div>
                                            <div class="form-group col">
                                                <label for="tension" class="label-form">Description resultat:</label>
                                                <textarea name="description" id="" cols="15" class="form-control" rows="6" style="border:none;" disabled></textarea>
                                            </div>
                                        </div>
                                    </form>                        
                            </div>
                        ...
                        <div id="menu3" class="container tab-pane fade" style="height:100%; background:white;"><br>     
                            ...
                            <div class="fermerv" id="traitement">
                                <form action="">
                                    <div id="formtraitement">
                            ...
                            <div class="">
                                <div class="card mb-3 mt-3 ">
                                    <div class="card-header ml-0">
                                        <h3>Création d'un nouveau dossier medicalcal</h3>
                                    </div>
                                    <div class="card-body">
                                        <div>
                                            <form class="form-group" action="/action_page.php">
                                                <div class="row justify-content-between">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control" name="numpatient"  style="width:100px; height:32px;" disabled>
                                                    </div>
                                                    <div class="form-group ">
                                                        <label for="temp" class="label-form">Temperature:</label>
            ...
            <div class="col-5  mt-3" style="height:100%;background-color:white;text-align:justify;">
                <div class="alert alert-primary" style="margin-bottom:0px;">
                    ...
                    <div class="row justify-content-between">
                        <a  class="btn btn-primary" id="createfolder" href="#">
                        ...
                        <a href="#" class="btn btn-primary afficherv" style="width:150px;" id="newtraitement">New Traitement</a>
                    </div>
                </div>
